...
////////////////////////////////////////////////////////////////////////////U
    ...
    eos.getAccount(BPACCOUNTNAME).then(AccInfo => {
      ...
      let total = this.balance(this.state.bpbalance) + this.balance(this.state.bpcpu) + this.balance(this.state.bpban) + this.balance(this.state.bpUnstake)
      this.setState({
    ...
    eos.getAccount(DIVACCOUNTNAME).then(AccInfo => {
      ...
      let total = this.balance(this.state.divbalance) + this.balance(this.state.divcpu) + this.balance(this.state.divban) + this.balance(this.state.divUnstake)
      this.setState({
    ...
    eos.getAccount(PROACCOUNTNAME).then(AccInfo => {
      ...
      let total = this.balance(this.state.probalance) + this.balance(this.state.procpu) + this.balance(this.state.proban) + this.balance(this.state.proUnstake)
      this.setState({
        ...
        <Grid container spacing={24} direction="row">
          <Grid item xs={12} sm={12}>
            ...
            <Paper
              ...
              elevation={10}
            >
              <Typography variant="headline" variant="caption" style={{
                color: "white",
                topMargin: -10,
              }}>
